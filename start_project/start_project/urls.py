#  this file is responsible for mapping the routers and paths in out
# project For example, if you want to show something in URL /about/,
# you have to map it
# here first
...
urlpatterns = [
    ...
    # \d+will matchan integer of arbitrary size.This integerwill be used to
    # retrievethe Board from thedatabase. (?P<pk>\d+) this is telling Django
    # to capture the value into a keyword argument names pk
